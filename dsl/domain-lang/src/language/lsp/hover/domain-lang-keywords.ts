export const keywordExplanations: Record<string, string> = {
    ...
    group: "**Group**\n\nA group is a namespace for organizing related elements and avoiding naming collisions. Groups can be nested and imported.",
    import: "**import**\n\nImports types or groups from another file or module, enabling reuse and modularity.",
